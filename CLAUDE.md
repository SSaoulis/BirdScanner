...
**`birdscanner/ml/geomodel.py`** — BirdNET geomodel (spatio-temporal species prior) + the geomodel↔classifier **label crosswalk** (WIP on the `geomodel-dev` branch; mapping helpers unit-tested in `tests/ml/test_geomodel.py`):
