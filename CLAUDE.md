...
**`birdscanner/detector/settings_controller.py`** — applies settings to the running detector (mirrors `crop_controller.py`; unit-tested in `tests/detector/test_settings_controller.py`):
...
**`birdscanner/detector/geo_priors.py`** — startup orchestration for the geomodel prior (unit-tested in `tests/detector/test_geo_priors.py`):
